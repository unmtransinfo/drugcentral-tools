...
tgts_pd <- tgts_pd[(moa) & !is.na(umls_cui), .(n_drug = uniqueN(struct_id)), by=c("umls_cui", "omop_concept", "gene", "target_name")][order(omop_concept)]
knitr::kable(tgts_pd, caption="Parkinson Disease: MOA Targets")
```
