...
public class DrugDBTargetComponent
{
  ...
  private DrugDBTargetComponent() {} //disallow default constructor

  public DrugDBTargetComponent(Integer _id)
  {
    this.id = _id;
