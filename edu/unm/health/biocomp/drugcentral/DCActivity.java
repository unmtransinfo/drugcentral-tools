...
/**	Represents one DC activity, an interaction between one compound
	...
	implements Comparable<Object>
{
  ...
  private DCActivity() {} //disallow default constructor

  public DCActivity(Integer _id)
  {
    this.id = _id;
  }
  ...
  public void setTarget(DCTarget _tgt) { this.tgt = _tgt; }
  public DCTarget getTarget() { return this.tgt; }
  ...
  public void setSourceUrl(String _source_url) { this.source_url = _source_url; }
  public String getSourceUrl() { return this.source_url; }
  ...
  public void setMoaSourceUrl(String _moa_source_url) { this.moa_source_url =
_moa_source_url; }
  public String getMoaSourceUrl() { return this.moa_source_url; }
  ...
  {
    if (this.getMoa()==1 && ((DCActivity)o).getMoa()!=1) return -1;
    else if (this.getMoa()!=1 && ((DCActivity)o).getMoa()==1) return 1;
    else if (this.getMoaType()!=null && ((DCActivity)o).getMoaType()==null) return -1;
    else if (this.getMoaType()==null && ((DCActivity)o).getMoaType()!=null) return 1;
    else return ((String)(this.getTarget().getName())).compareToIgnoreCase((String)(((DCActivity)o).getTarget().getName()));
  }
}
